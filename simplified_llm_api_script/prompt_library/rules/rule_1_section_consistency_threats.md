...
### Preferred Style
The major threat affecting this species is
...
5. **Biological Resource Use**
   ...
   - 5.3 Logging & Wood Harvesting
     - 5.3.1 Intentional Use: subsistence/small scale (species is the target)
     - 5.3.2 Intentional Use: large scale (species is the target)
     - 5.3.3 Unintentional Effects: subsistence/small scale (species is not the target)
     - 5.3.4 Unintentional Effects: large scale (species is not the target)
     - 5.3.5 Motivation Unknown/Unrecorded
   - 5.4 Fishing & Harvesting Aquatic Resources
     - 5.4.1 Intentional Use: subsistence/small scale (species is the target)
     - 5.4.2 Intentional Use: large scale (species is the target)
     - 5.4.3 Unintentional Effects: subsistence/small scale (species is not the target)
     - 5.4.4 Unintentional Effects: large scale (species is not the target)
