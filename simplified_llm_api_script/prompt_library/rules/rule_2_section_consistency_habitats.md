...
### Preferred Style
Most specimens have been found in reasonably
...
Ensure that all relevant habitats (those given in the narrative) have been listed in the Habitat classification scheme section.
...
The three levels of the hierarchy are self-explanatory, as they use familiar habitat terms that take into account biogeography, latitudinal zonation and depth in marine systems. The inland aquatic habitats are based primarily on the classification system of wetland types used by the Ramsar Convention.
